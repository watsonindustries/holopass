...
<div class="card mx-auto mt-[40vh] flex w-96 items-center bg-slate-50 shadow-xl">
	<div class="card-body items-center space-y-4">
		<h2 class="card-title text-4xl text-accent font-bold tracking-tight">Sign In</h2>
