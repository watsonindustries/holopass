<script lang="ts">
	...
	import type { CheckInPostRequestBody, CheckInPostResponseBody } from '../../../api/check-in/+server';
...
>
	...
	>
		<section class="flex flex-col p-4">
			...
			{#if data}
				{#if data.error}
					<div class="flex-row card bg-red-600 p-2 text-white place-content-center text-center">
				...
				{:else}
					<div class="flex-row card bg-green-600 p-2 text-white place-content-center text-center">
						<div class="align-center">
